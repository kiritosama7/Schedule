package com.dl.schedule.linechart;
...
public class DoubleLineChartView extends View {
    ...
    public DoubleLineChartView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DoubleLineChartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
