...
import com.dl.schedule.util.HttpUtil;
import com.dl.schedule.util.Utility;
...
public class ChooseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<>(ChooseActivity.this, android.R.layout.simple_list_item_1, dataList);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (currentLevel == LEVEL_PROVINCE) {
                    ...
                    editor = PreferenceManager.
                            getDefaultSharedPreferences(ChooseActivity.this).edit();
